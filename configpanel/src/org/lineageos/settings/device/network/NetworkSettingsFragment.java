...
package org.lineageos.settings.device.network;
...
public class NetworkSettingsFragment extends PreferenceFragment
    ...
    public void addPreferencesFromResource(int preferencesResId) {
        ...
        this.addPreference(Settings.Secure.WIFI_ACTIONS);
        this.addPreference(Settings.Secure.WIFI_ACTIONS_2G);
        this.addPreference(Settings.Secure.WIFI_ACTIONS_MOBILE_DATA);
    }
